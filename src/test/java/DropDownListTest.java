...
public class DropDownListTest {
    ...
    public DropDownListTest(String questionLocator, String answerLocator, String answerText) {
    ...
    public void dropDownList() {
        ...
        assertEquals("Текст не соответствует ожидаемому результату", answerText, ActualAnswerText);
    }
